// code is heavyly copied from https://github.com/creasty/defaults/
package testutil
...
var (
	errInvalidType = xerrors.New("not a struct pointer")
)
...
func FillTestData(ptr interface{}) error {
	return Set(ptr)
}
...
func Set(ptr interface{}) error {
	...
	for i := 0; i < t.NumField(); i++ {
		testVal := t.Field(i).Tag.Get(fieldName)
		if err := setField(v.Field(i), testVal); err != nil {
			return err
		}
	}
	callSetter(ptr)
